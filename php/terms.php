...
<main>
    <div class="content">
        <h2>APPLE TERMS OF SLAVERY</h2>
        <p>
            <p>THE LEGAL AGREEMENTS SET OUT BELOW GOVERN YOUR USE OF THE ITUNES STORE, MAC APP STORE, APP STORE, APP STORE FOR APPLE TV, IBOOKS STORE AND APPLE MUSIC SERVICES ("SERVICES"). TO AGREE TO THESE TERMS, CLICK "AGREE." IF YOU DO NOT AGREE TO THESE TERMS, DO NOT CLICK "AGREE," AND DO NOT USE THE SERVICES.</p>
            
            <p>A. TERMS OF SALE</p>
            
            </p>PAYMENTS, TAXES, AND REFUND POLICY</p>
            
            <p>You agree that you will pay for all products you purchase through the Services, and that Apple may charge your payment method for any products purchased and for any additional amounts (including any taxes and late fees, as applicable) that may be accrued by or in connection with your Account. YOU ARE RESPONSIBLE FOR THE TIMELY PAYMENT OF ALL FEES AND FOR PROVIDING APPLE WITH A VALID PAYMENT METHOD FOR PAYMENT OF ALL FEES. For details of how purchases are billed please visit <a href="http://support.apple.com/kb/HT5582">http://support.apple.com/kb/HT5582</a>.</p>
            
            <p>Your total price will include the price of the product plus any applicable tax; such tax is based on the bill-to address and the tax rate in effect at the time you download the product.</p>
            
            <p>All sales and rentals of products are final.</p>
            
            <p>Prices for products offered via the Services may change at any time, and the Services do not provide price protection or refunds in the event of a price reduction or promotional offering.</p>
            
            <p>If a product becomes unavailable following a transaction but prior to download, your sole remedy is a refund. If technical problems prevent or unreasonably delay delivery of your product, your exclusive and sole remedy is either replacement or refund of the price paid, as determined by Apple.</p>
            
            <p>1-Click®</p>
            
            <p>1-Click is a registered service mark of Amazon.com, Inc., used under license. 1-Click is a convenient feature that allows you to make a purchase from the Services with a single click of your mouse or other input device. When accessing the Services on your computer, 1-Click purchasing may be activated via the dialog that appears when you click a Buy button. (You may reset this selection at any time by clicking Reset Warnings in your Account information). When accessing the Services on your Apple-branded products running iOS such as an iPad, iPod touch, or iPhone (“iOS Device”), 1-Click is activated for each transaction by tapping the button showing the price of the product, which reveals the Buy button. When 1-Click is activated, clicking or tapping the Buy button starts the download immediately and completes your transaction without any further steps.</p>
            
            <p>GIFT CERTIFICATES, ITUNES CARDS AND CODES, ALLOWANCES, AND CONTENT CODES</p>
            
            <p>Gift Certificates, iTunes Cards and Codes, and Allowances are issued and managed by Apple Value Services, LLC (“Issuer”).</p>
            
            <p>Gift Certificates, iTunes Cards and Codes, Content Codes, and Allowances, in addition to unused balances, are not redeemable for cash and cannot be returned for a cash refund (except as required by law); exchanged; resold; used to purchase Gifts, Gift Certificates, or iTunes Cards or Codes; used to provide Allowances; used for purchases on the Apple Online Store; or used in Apple Retail Stores. Unused balances are not transferable.</p>
            
            <p>Gift Certificates, iTunes Cards and Codes, Content Codes, and Allowances purchased in the United States may be redeemed through the Services only in the United States, its territories, and possessions.</p>
            
            <p>The Gift Certificate/iTunes Card/Code cash value is 1/10 of one cent.</p>
            
            <p>Neither Issuer nor Apple is responsible for lost or stolen Gift Certificates, iTunes Cards or Codes, Content Codes, or Allowances. Risk of loss and title for Gift Certificates, iTunes Cards and Codes, and Allowances transmitted electronically pass to the purchaser in Virginia upon electronic transmission to the recipient. Risk of loss and title for Content Codes transmitted electronically pass in California upon electronic transmission from Apple; for avoidance of doubt, such recipient may not always be you.</p>
            
            <p>Apple reserves the right to close accounts and request alternative forms of payment if a Gift Certificate, iTunes Card or Code, Content Code, or Allowance is fraudulently obtained or used on the Service.</p>
            
            <p>APPLE, ISSUER, AND THEIR LICENSEES, AFFILIATES, AND LICENSORS MAKE NO WARRANTIES, EXPRESS OR IMPLIED, WITH RESPECT TO GIFT CERTIFICATES, ITUNES CARDS OR CODES, CONTENT CODES, ALLOWANCES, OR THE ITUNES STORE, APP STORE, MAC APP STORE, OR IBOOKS STORE, INCLUDING, WITHOUT LIMITATION, ANY EXPRESS OR IMPLIED WARRANTY OF MERCHANTABILITY OR FITNESS FOR A PARTICULAR PURPOSE. IN THE EVENT THAT A GIFT CERTIFICATE, ITUNES CARD OR CODE, CONTENT CODE, OR ALLOWANCE IS NONFUNCTIONAL, YOUR SOLE REMEDY, AND OUR SOLE LIABILITY, SHALL BE THE REPLACEMENT OF SUCH GIFT CERTIFICATE, ITUNES CARD OR CODE, CONTENT CODE, OR ALLOWANCE. THESE LIMITATIONS MAY NOT APPLY TO YOU. CERTAIN STATE LAWS DO NOT ALLOW LIMITATIONS ON IMPLIED WARRANTIES OR THE EXCLUSION OR LIMITATION OF CERTAIN DAMAGES. IF THESE LAWS APPLY TO YOU, SOME OR ALL OF THE ABOVE DISCLAIMERS, EXCLUSIONS, OR LIMITATIONS MAY NOT APPLY TO YOU, AND YOU MAY ALSO HAVE ADDITIONAL RIGHTS.</p>
            
            <p>GIFTS</p>
            
            <p>Gifts purchased from the Services may be purchased only for, and redeemed only by, persons in the United States, its territories, and possessions. Gift recipients must have compatible hardware and parental control settings to utilize some gifts.</p>
            
            <p>PRE-ORDERS</p>
            
            <p>By pre-ordering products, you are authorizing the Services to automatically charge your account and download the product when it becomes available. You may cancel your pre-order prior to the time the item becomes available.</p>
            ...
            Apple, the Apple logo, iTunes, and other Apple trademarks, service marks, graphics, and logos used in connection with the iTunes Service are trademarks or registered trademarks of Apple Inc. in the U.S. and/or other countries. Other trademarks, service marks, graphics, and logos used in connection with the iTunes Service may be the trademarks of their respective owners.
        </p>
    </div>
</main>
</body>
